...
<body>
  ...
  <div style="position: absolute; top: 92%; left: 50%; font-size: 1.5vw; transform: translate(-50%, -50%); font-family: FontAwesome, 'Open Sans', Verdana, sans-serif; color: #111;" id="total" >
		Pledge now @ becounted2018.com
  </div>
